...
var presenterView = (function() {
    ...
    var getCurrSlide = function() {
        if (currentItem.nodeName === 'SECTION') {
            return currentItem.innerHTML;
        } else {
            return 'test';
        }
    };
    ...
    return {
        ...
        storeNextSlide: function() {
         ...
         storeCurrSlide: function() {
            addItemToLocalStorageArray('curr_slide', getCurrSlide());
        },
        ...
        write: function() {
            ...
            if (writeToLocalStorage.curr_slide !== 'undefined') {
                localStorage.setItem('curr_slide', writeToLocalStorage['curr_slide']);
            }
